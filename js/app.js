        ...
        e.exports = (function () {
          ...
          var t = "undefined" != typeof window,
            ...
            W = function (e, t, s) {
              $(e, t.class_loading),
                S(e, h),
                s && (I(s, 1), P(t.callback_loading, e, s));
            },
            X = function (e, t, s) {
              s && e.setAttribute(t, s);
            },
            Y = function (e, t) {
              X(e, p, y(e, t.data_sizes)),
                X(e, c, y(e, t.data_srcset)),
  ...
  (() => {
    ...
    const g = {
      ...
      offset: function () {
        if (this.length > 0) {
          ...
          return { top: i.top + o - a, left: i.left + c - r };
        }
        return null;
      },
      css: function (e, t) {
        ...
        if (
          ...
          if (0 === t) l[e ? "scrollLeft" : "scrollTop"] = -c;
            ...
            if (!a.support.smoothScroll)
              return (
                E({ swiper: a, targetPosition: -c, side: e ? "left" : "top" }),
                !0
              );
    ...
    function re({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      (e.autoplay = { running: !1, paused: !1 }),
        ...
        Object.assign(e.autoplay, { pause: d, run: a, start: r, stop: o });
    }
    function le({ swiper: e, extendParams: t, on: s }) {
      ...
      function a() {
        ...
        const s = t.clickedIndex,
          i = t.clickedSlide;
        if (i && v(i).hasClass(e.params.thumbs.slideThumbActiveClass)) return;
        if (null == s) return;
        let n;
        if (
          ((n = t.params.loop
            ? parseInt(v(t.clickedSlide).attr("data-swiper-slide-index"), 10)
            : s),
          e.params.loop)
        ) {
          let t = e.activeIndex;
    ...
    window.addEventListener("load", function (e) {
      !(function () {
        if ((ce(), document.querySelector(".thumbs-images"))) {
          const e = new te(".thumbs-images", {
            modules: [ie, ae, re, le],
            observer: !0,
            observeParents: !0,
            slidesPerView: 4,
        ...
        document.querySelector(".reviews__slider") &&
          ...
          document.querySelector(".products-slider__slider") &&
            new te(".products-slider__slider", {
              modules: [ie, ae, re],
              autoplay: { delay: 3e3, disableOnInteraction: !1 },
              observer: !0,
              observeParents: !0,
